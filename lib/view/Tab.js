...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cm("flexlayout__tab", this.props.node), onMouseDown: this.onMouseDown, onTouchStart: this.onMouseDown, style: style }, child));
    };
    return Tab;
}(React.Component));
exports.Tab = Tab;
