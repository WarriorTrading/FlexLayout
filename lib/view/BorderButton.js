...
var BorderButton = /** @class */ (function (_super) {
    ...
    BorderButton.prototype.render = function () {
        ...
        if (this.props.node.isEnableClose()) {
            closeButton = React.createElement("div", { className: cm("flexlayout__border_button_trailing"), onMouseDown: this.onCloseMouseDown, onClick: this.onClose, onTouchStart: this.onCloseMouseDown });
        }
