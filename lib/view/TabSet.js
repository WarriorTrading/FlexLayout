    ...
    TabSet.prototype.render = function () {
        ...
        if (this.showToolbar === true) {
            if (this.props.node.isEnableMaximize()) {
                buttons.push(React.createElement("button", { key: "max", className: cm("flexlayout__tab_toolbar_button-" + (node.isMaximized() ? "max" : "min")), onClick: this.onMaximizeToggle }));
            }
            toolbar = React.createElement("div", { key: "toolbar", ref: function (ref) { return _this.toolbarRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__tab_toolbar"), onMouseDown: this.onInterceptMouseDown }, buttons);
        }
        if (this.showOverflow === true) {
            tabs.push(React.createElement("button", { key: "overflowbutton", ref: function (ref) { return _this.overflowbuttonRef = (ref === null) ? undefined : ref; }, className: cm("flexlayout__tab_button_overflow"), onClick: this.onOverflowClick.bind(this, hiddenTabs), onMouseDown: this.onInterceptMouseDown }, hiddenTabs.length));
        }
