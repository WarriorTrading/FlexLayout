...
var Splitter = /** @class */ (function (_super) {
    ...
    function Splitter() {
        ...
        _this.onMouseDown = function (event) {
            ...
            _this.outlineDiv.className = _this.props.layout.getClassName("flexlayout__splitter_drag", _this.props.node);
            _this.outlineDiv.style.cursor =
                _this.props.node.getOrientation() === Orientation_1.default.HORZ
                    ? "ns-resize"
                    : "ew-resize";
    ...
    Splitter.prototype.render = function () {
        ...
        var style = node._styleWithPosition({
            cursor: this.props.node.getOrientation() === Orientation_1.default.HORZ
                ? "ns-resize"
                : "ew-resize"
        });
        return (React.createElement("div", { style: style, onTouchStart: this.onMouseDown, onMouseDown: this.onMouseDown, className: cm("flexlayout__splitter", this.props.node) }));
    };
    return Splitter;
}(React.Component));
