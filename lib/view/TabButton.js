...
var Content = React.forwardRef(function (props, ref) {
    var editing = props.editing, cm = props.cm, node = props.node, onTextBoxKeyPress = props.onTextBoxKeyPress, onTextBoxMouseDown = props.onTextBoxMouseDown, renderState = props.renderState;
    var contentRef = React.useRef(null);
