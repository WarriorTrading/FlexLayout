...
var TabButton = /** @class */ (function (_super) {
    ...
    TabButton.prototype.updateRect = function () {
        ...
        this.contentWidth = this
            .contentRef.getBoundingClientRect().width;
    };
    ...
    TabButton.prototype.render = function () {
        ...
        var classNames = cm("flexlayout__tab_button", this.props.node);
        ...
        var content = (React.createElement("div", { ref: function (ref) { return (_this.contentRef = ref === null ? undefined : ref); }, className: cm("flexlayout__tab_button_content", this.props.node) }, renderState.content));
        var leading = (React.createElement("div", { className: cm("flexlayout__tab_button_leading", this.props.node) }, renderState.leading));
        if (this.state.editing) {
            var contentStyle = { width: this.contentWidth + "px" };
            content = (React.createElement("input", { style: contentStyle, ref: function (ref) { return (_this.contentRef = ref === null ? undefined : ref); }, className: cm("flexlayout__tab_button_textbox", this.props.node), type: "text", autoFocus: true, defaultValue: node.getName(), onKeyDown: this.onTextBoxKeyPress, onMouseDown: this.onTextBoxMouseDown, onTouchStart: this.onTextBoxMouseDown }));
        }
        var closeButton;
        if (this.props.node.isEnableClose()) {
            closeButton = (React.createElement("div", { className: cm("flexlayout__tab_button_trailing", this.props.node), onMouseDown: this.onCloseMouseDown, onClick: this.onClose, onTouchStart: this.onCloseMouseDown }));
        }
